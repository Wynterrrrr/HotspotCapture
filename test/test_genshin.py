...
from routes.genshin import get_genshin_hot

async def test_genshin():
    """测试原神最新消息接口"""
    print("正在测试原神最新消息接口（公告）...")
    
    try:
        result = await get_genshin_hot(type="1")
    ...
    try:
        result = await get_genshin_hot(type="2")
    ...
    try:
        result = await get_genshin_hot(type="3")
...
if __name__ == "__main__":
    success = asyncio.run(test_genshin())
